...
require('lazy').setup({
...

  {
    ...
    dependencies = {
      ...
      -- Adds completion for local file paths
      'hrsh7th/cmp-path',
    },
  },
  ...
  {
    -- linter support to enable more strict checking
  ...
  -- adds a better text writing experience
...
vim.defer_fn(function()
  require('nvim-treesitter.configs').setup {
    ...
    ensure_installed = { 'c', 'cpp', 'go', 'lua', 'norg', 'python', 'rust', 'tsx', 'javascript', 'typescript', 'vimdoc', 'vim', 'bash', 'sql' },
